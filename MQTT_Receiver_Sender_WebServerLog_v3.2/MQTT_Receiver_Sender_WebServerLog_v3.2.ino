...
const char* esp8266unitNumber = "ESP8266Client_8";  // Set a esp8266unitNumber to identify each unit
...
const char* MQTT_PUB_TOPIC = "ESP8266/Controller_8";// Set the MQTT publishing topic to use
