...
const char* esp8266unitNumber = "ESP8266Client_5"; // Set a esp8266unitNumber to identify each unit
...
const char* MQTT_PUB_TOPIC = "ESP8266/Controller"; // Set the MQTT publishing topic to use
...
// Debounce interval for the buttons, in milliseconds (1000 = 1 second)
const int debounceInterval = 1000;
