...
const char* esp8266unitNumber = "ESP8266Client_1";  // Set a esp8266unitNumber to identify each unit
const char* WIFI_SSID = "your_ssid";                // Set the WIFI ssid to connect to
const char* WIFI_PASSWORD = "your_password";        // Set the WIFI password
const char* MQTT_SERVER = "your_mqtt_server";       // Set the MQTT server ip address
const int MQTT_PORT = 1883;                         // Set the MQTT port number
const char* MQTT_USERNAME = "your_mqtt_username";   // Set the MQTT username to use
const char* MQTT_PASSWORD = "your_mqtt_password";   // Set the MQTT password to use
const char* MQTT_PUB_TOPIC = "ESP8266/Controller_1";// Set the MQTT publishing topic to use
...
// const int buttonPin0 = D0;       // Button 0 input pin (GPIO16) // TODO: solve button and led sticking issue before enabling, in use as built in LED
...
const int debounceInterval = 1000;  // Debounce interval for the buttons, in milliseconds (1000 = 1 second)
