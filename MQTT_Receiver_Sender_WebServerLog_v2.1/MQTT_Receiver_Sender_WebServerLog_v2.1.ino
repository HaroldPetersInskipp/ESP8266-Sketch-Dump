...
const char* esp8266unitNumber = "ESP8266Client_7";  // Set a esp8266unitNumber to identify each unit
...
const char* MQTT_PUB_TOPIC = "ESP8266/Controller_4";// Set the MQTT publishing topic to use
