...
const char* esp8266unitNumber = "ESP8266Client_1";  // Set a esp8266unitNumber to identify each unit (example "ESP8266Client_NUM")
const char* WIFI_SSID = "YOUR_WIFI_SSID";           // Set the WIFI ssid to connect to (example "Hello world")
const char* WIFI_PASSWORD = "YOUR_WIFI_PASSWORD";   // Set the WIFI password (example "Hello world")
const char* MQTT_SERVER = "YOUR_MQTT_SERVER";       // Set the MQTT server ip address (example "10.0.0.111")
const int MQTT_PORT = 1883;                         // Set the MQTT port number (default port is 1883)
const char* MQTT_USERNAME = "YOUR_MQTT_USERNAME";   // Set the MQTT username to use (example "Hello world")
const char* MQTT_PASSWORD = "YOUR_MQTT_PASSWORD";   // Set the MQTT password to use (example "Hello world")
const char* MQTT_PUB_TOPIC = "ESP8266/Controller_1";// Set the MQTT publishing topic to use (example ESP8266/Controller_NUM")
...
const int debounceInterval = 200;   // Debounce interval for the buttons, in milliseconds (1000 = 1 second)
