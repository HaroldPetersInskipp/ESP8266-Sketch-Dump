...
const char* esp8266unitNumber = "ESP8266Client_2";  // Set a esp8266unitNumber to identify each ESP8266 NodeMCU (example "ESP8266Client_1")
...
const char* MQTT_PUB_TOPIC = "ESP8266/Controller_2";// Set the MQTT publishing topic to use (example "ESP8266/Controller_1")
...
// const int ESP8266_BUILTIN_LED = D2;  // Onboard LED (GPIO4) pin D2 // in use as buttonPin2
